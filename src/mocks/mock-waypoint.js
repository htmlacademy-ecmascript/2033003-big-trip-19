import { Integer, DateType, OFFERS, POINT_TYPES} from '../const.js';
...
const createDataPoints = (destinations)=> Array.from({ length: Integer.MAX_COUNT_OBJECTS }, (_element,integer) =>
  createDataPoint(integer + 1, DateType.MAX_DATE, DateType.MIN_DATE,Integer.MAX_INTEGER_DATE_DURATION, getRandomArrayElement(POINT_TYPES), destinations));
